...
TextRenderer::TextRenderer(GLuint width, GLuint height)
{
    ...
    this->TextShader = ResourceManager::LoadShader("../shader/textShader.vs", "../shader/textShader.fs", nullptr, "text");
    this->TextShader.use();
    //this->TextShader.setMat4("projection", glm::perspective(glm::radians(camera.Zoom),
    //    (float)WINDOW_W / (float)WINDOW_H,
    //    0.1f, CAMERA_FAR), GL_TRUE);
